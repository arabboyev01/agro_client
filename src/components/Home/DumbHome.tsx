...
const DumbHomePage: FC<{ lang: TFunction<"translation", undefined>, handleRoute: (route: string) => void }> = ({ lang , handleRoute}) => (
    <S.StyleHomePage>
        <S.LeftContent>
        ...
        <S.MiddleContent>
            ...
            <MainButton width={185} height={45} text={lang('call')} textSize={12}/>
